...
# Homebrew も付けるので、そのままでは初回に「開発元を確認できません」を通る
# ことになる——dmg を手で開いたときと同じである。`--no-quarantine` を付けると
# 印が付かず、そこを通らずに開く。**cask 側でそれを既定にはできない**
# （Homebrew が casks から quarantine の打ち消しを取り上げた。Gatekeeper を
# 黙って迂回する cask を作れないようにするためであり、その判断は正しい）。
cask "sshc" do
  arch arm: "arm64", intel: "x64"

  version "0.3.1"
  sha256 arm: "e904ddd2c7802c4e676051ba29b8dffacf3a892f4f44a7750b1948ea843a4e15",
         intel: "bf34ace9c6f848eb13e8a3f31a24182f91e512a4f4d76986521623ed89ff1cd4"
